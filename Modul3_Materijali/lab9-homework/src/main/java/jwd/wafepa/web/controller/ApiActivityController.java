...
public class ApiActivityController {
	...
	ResponseEntity<List<ActivityDTO>> getActivities(
		...
		HttpHeaders headers = new HttpHeaders(); // objekat headers služi za prosleđivanje željenih parametara u front-end preko header-a
		List<Activity> retVal = activities.getContent();
		int totalPages = activities.getTotalPages();
		headers.add("TotalPages", totalPages+""); // totalPages+"" umesto String.valueOf(totalPages) ili Integer.toString(totalPages)
