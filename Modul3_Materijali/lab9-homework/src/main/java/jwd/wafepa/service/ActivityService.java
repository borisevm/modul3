...
public interface ActivityService {
	 ...
	 * @return
	 */
	Iterable<Activity> save(List<Activity> activities);
	 ...
	 */
	Page<Activity> findByName(String name, int page); //Metode u servis i repository slojevima ne moraju imati isto ime 
